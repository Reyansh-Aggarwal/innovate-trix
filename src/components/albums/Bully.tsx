...
import albumImage from "../../assets/images/album-covers/bully.png";

export const Bully = () => {

    const list = ["SHAVING CREAM", "RAZOR", "SLEEP MASKS", "LOTION"];

    return (
        <div className={cn(
            "w-full min-h-dvh flex flex-col justify-between md:justify-around items-center select-none",
            "bg-dark text-white font-druk-bold"
        )}>
            <div className="w-full h-fit text-center pt-8 pb-16 md:pt-0 md:pb-0 animate-fade-in opacity-0">
                <h1 className="font-maximo tracking-[-0.2rem] text-8xl">BULLY</h1>
            </div>
